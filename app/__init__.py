...
def create_app():
    ...
    from app.routes import auth, empresa, productos, ventas_factura, carrito, dispositivos, pago, reparaciones, historial_reparacion, notificaciones, mensaje_soporte, detalle_venta
